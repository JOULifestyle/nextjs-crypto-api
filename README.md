...
A NestJS-based REST API for cryptocurrency data with user authentication. Features include email/password and Google OAuth login, fetching crypto data from CoinGecko, storing in SQLite database, and serving data via protected endpoints.
...
- `DB_PATH`: Path to SQLite file (default: `./database.sqlite`).
